...
public class TamilDesktopLandingPage {
	...
	public TamilDesktopLandingPage(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath="//ul[contains(@class,'sub_navigation_ul')]//a[contains(@href,'/photogallery/')]")

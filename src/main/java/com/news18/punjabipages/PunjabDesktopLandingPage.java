...
public class PunjabDesktopLandingPage {
	...
	public PunjabDesktopLandingPage(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath ="//div[contains(@class,'container')]//a[contains(@title,'LIVE')]")
	private List<WebElement> homePageLiveBlogArticleLnk;
	
	/*photo section Present in Line One navigation bar */
	@FindBy(xpath="(//nav[contains(@class,'clearfix')]//a[contains(@href,'/photogallery/')])[1]")

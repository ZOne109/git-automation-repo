...
public class OdiaDesktopLandingPage  {
	...
	public OdiaDesktopLandingPage(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath="//div[contains(@class,'sub_right')]//a[contains(@href,'/photogallery/')]")
